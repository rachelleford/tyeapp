...
class OneTwo extends StatefulWidget {
  @override
  _OneTwoState createState() => _OneTwoState();
}

class _OneTwoState extends State<OneTwo> {
  late VideoPlayerController _videoController;

  @override
  void initState() {
    super.initState();
    _videoController = VideoPlayerController.asset('lib/assets/onethree.mp4')
      ..initialize().then((_) {
        setState(() {});
      })
      ..setLooping(true);
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCheckboxTile(context,
                title: 'Realistic Monthly Budget', navigateTo: BudgetBuilder()),
            _buildCheckboxTile(context,
